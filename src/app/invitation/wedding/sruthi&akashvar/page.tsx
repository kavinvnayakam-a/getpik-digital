...
export default function LongScrollWeddingInvitation() {
  ...
  const layers = [
    ...
    { id: 4, url: "https://firebasestorage.googleapis.com/v0/b/getpik-digital.firebasestorage.app/o/Sruthiwedding%20invitation%2FTemple%20-4%20.webp?alt=media&token=6b6a3581-36a8-47d4-89f3-e362d336a272" },
  ...
  return (
    <div className="relative w-full bg-[#001f3f] min-h-screen">
      <Head>
      ...
      <div className="relative w-full overflow-hidden" style={{ aspectRatio: '1080 / 3840' }}>
        {layers.map((layer) => (
          <img key={layer.id} src={layer.url} alt="" className="absolute top-0 left-0 w-full h-full pointer-events-none" style={{ objectFit: 'fill' }} />
        ))}

        <div className="absolute inset-0 flex flex-col items-center z-10">
          
          {/* Header (190px top) */}
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="pt-[190px] text-center px-8">
            <div className="space-y-4 mb-6">
              ...
              <p className="text-[#5d1a1a]/80 italic text-[11px] leading-relaxed max-w-[280px] mx-auto uppercase tracking-wider font-medium">
            ...
            <div className="py-2">
              <h1 className="text-6xl text-[#5d1a1a] font-dancing">Sruthi</h1>
              <Heart className="mx-auto text-[#d4af37] fill-[#d4af37] animate-pulse my-2" size={24} />
              <h1 className="text-6xl text-[#5d1a1a] font-dancing">Akashvar</h1>
            </div>
          </motion.div>

          {/* --- TIMELINE (830px top) --- */}
<div className="absolute top-[830px] w-full px-10 max-w-[420px]">
  <div className="relative border-l-2 border-dotted border-white/40 ml-4 pl-8 space-y-12 py-2 text-white">
    ...
    <div className="relative">
      ...
      <h4 className="font-black text-[10px] uppercase tracking-[0.3em] text-white mb-1">
        Reception
      </h4>
      <p className="font-bold text-lg leading-none text-white">
        19th May 2026, Tuesday
      </p>
      <p className="text-xs italic mt-2 border-t border-white/40 pt-1 inline-block text-white">
    ...
    <div className="relative">
      ...
      <p className="text-xs font-black mt-2 border-t border-white/40 pt-1 inline-block text-white">
        9:00 AM to 9:45 AM
      </p>
    </div>
          ...
          <div className="absolute top-[1030px] w-full px-8 flex flex-col items-center">
             <div className="bg-white/95 backdrop-blur-md p-6 rounded-[2.5rem] border border-[#d4af37]/30 w-full max-w-[280px] shadow-2xl text-[#5d1a1a] text-center">
                <a href="https://maps.app.goo.gl/dHgZWKKSi2qJ8a4e8" target="_blank" className="flex flex-col items-center gap-1 group">
                ...
                <a href="https://calendar.google.com/calendar/render?action=TEMPLATE&text=Sruthi+%26+Akashvar+Wedding&dates=20260519T180000/20260520T100000&location=Kongu+Maligai,+Erode" target="_blank" className="text-[9px] font-black uppercase tracking-widest text-[#5d1a1a] flex justify-center items-center gap-2 underline">Save Date</a>
             </div>

             <div className="mt-12 text-center text-white/80">
                <p className="text-[9px] uppercase tracking-[0.4em] mb-4 font-black">{timeLeft.passed ? "Celebrated" : "Countdown"}</p>
      ...
      {/* --- SECTION 2: iMESSAGE STYLE GUESTBOOK --- */}
      ...
      <style jsx global>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { background-color: #001f3f; font-family: 'Playfair Display', serif; }
